...
<div class="wrap">
	<?php
		...
		if ($result != '1') {
			?><div class="error fade"><p><strong><?php echo __( 'Oops, selected details doesnt exists.', ES_TDOMAIN ); ?></strong></p></div>
			<?php
				$form = array(
					'es_c_id' => '',
					'es_c_fromname' => '',
	...
	<div class="form-wrap">
		...
		<h3><?php echo __( 'Settings', ES_TDOMAIN ); ?></h3>
		<form name="es_form" method="post" action="#" onsubmit="return _es_submit()">
			...
			<p class="submit">
				<input name="publish" lang="publish" class="button add-new-h2" value="<?php echo __( 'Save Settings', ES_TDOMAIN ); ?>" type="submit" />
