...
<div class="wrap">
	...
	<h3><?php echo __( 'Sent Mails', ES_TDOMAIN ); ?></h3>
	<div class="tool-box">
		<?php
			...
			<div class="tablenav">
				<div class="alignleft">
					<select name="action" id="action">
						<option value="optimize-table"><?php echo __( 'Optimize Table', ES_TDOMAIN ); ?></option>
					</select>
					<input type="submit" value="<?php echo __( 'Optimize Table', ES_TDOMAIN ); ?>" class="button action" id="doaction" name="">
				</div>
		...
		<?php if ($fulltotal > 30 ) { ?>
			<div class="error fade"><p>
				<?php echo __( 'Note: Please click <strong>Optimize Table</strong> button to delete all reports except latest 10.', ES_TDOMAIN ); ?>
			</p></div>
		<?php } ?>
